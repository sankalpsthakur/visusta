  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        ...
        <Link
          href={`/${locale}/clients/${clientId}/settings`}
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        ...
        <Link
          href={`/${locale}/clients/${clientId}/evidence`}
          className="flex items-center gap-1 text-xs transition-opacity hover:opacity-70"
          style={{ color: 'var(--brand-accent)' }}
        >
          View all
          ...
          <ErrorBoundary>
            <div>
              ...
              <motion.div className="flex flex-col gap-3" variants={criticalActionsVariants} initial="hidden" animate="show">
                {changelog.critical_actions.map((action, i) => (
                  <CriticalActionCard key={action.regulation_id ?? `action-${i}`} entry={action} />
                ))}
              </motion.div>
            </div>
          </ErrorBoundary>
